...
public class KastanekPetrSemestralProject {
    ...
    //Semestral variables
    static int choice, count, size, hands;
    static float[][] matrix;
    static double[] sizes;
    static boolean isMatrix = true;
    static boolean isOrthogonal = true;
    static int pocet;
    ...
    private static void Semestral() {
        while (true) {
            ...
            System.out.println("Zadej vektory (Vstup <= 0 ukončí tuto část):");
...
//Methods for christmas project
    ...
    private static void SnowmenMenu() {
